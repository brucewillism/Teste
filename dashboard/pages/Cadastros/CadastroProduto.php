                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" name="pro_nome" class="form-control" data-inputmask="'alias': 'ip'" data-mask>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" name="pro_codigo_produto" class="form-control" data-inputmask="'alias': 'ip'" data-mask>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input id="preco" type="text" name="pro_preco_compra" class="form-control" data-inputmask="'alias': 'ip'" data-mask>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input id="preco2" type="text" name="pro_preco_venda" class="form-control" data-inputmask="'alias': 'ip'" data-mask>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <select name="id_categoria" class="form-control" data-inputmask="'alias': 'ip'" data-mask required>
                          <?php
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <div class="input-group">
                          ...
                          <input id="data" name="pro_data_compra" type="text" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask>
                        </div>
