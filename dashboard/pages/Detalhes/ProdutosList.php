					...
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						<li class="nav-item has-treeview menu-open">
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item">
									<a href="ProdutosList.php" class="nav-link active">
										<i class="far fa-circle nav-icon"></i>
										...
										?>
											...
											<tbody>
												<tr>
													...
													<td><a href="../Editar/EditarProduto.php?id=<?= $pro_id ?>" class="btn btn-info btn-xs">Editar</a></td>
													<td><a href="DetalheProduto.php?id=<?= $pro_id ?>" class="btn btn-info btn-xs">Visualizar</a></td>
													<td><a href="../Excluir/ExcluirProduto.php?id=<?= $pro_id ?>" class="btn btn-info btn-xs">Excluir</a></td>
												</tr>
											</tbody>
									</table>
								<?php
